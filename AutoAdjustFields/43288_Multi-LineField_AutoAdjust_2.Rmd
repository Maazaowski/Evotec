...
<UdDocument xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" ProductVersion="10.1.0.347">
  ...
  <Name>\\astera.com\share\general\Sadia Sayeed\FieldVerification\AutoAdjustFields\Multi-LineField_AutoAdjust_2.Rmd</Name>
  <Description />
  <CreateDtTm>0001-01-01T00:00:00</CreateDtTm>
  <UpdateDtTm>2022-12-06T07:51:52.0285915-08:00</UpdateDtTm>
  <CatalogInfo>
    <Name>Multi_LineField_AutoAdjust</Name>
  ...
  <Options>
    ...
    <SampleFilePath>
      <Path>\\astera.com\share\general\Sadia Sayeed\FieldVerification\MultiLineField_AutoAdjust.Txt</Path>
      <UncPath>\\astera.com\share\general\Sadia Sayeed\FieldVerification\MultiLineField_AutoAdjust.Txt</UncPath>
    </SampleFilePath>
    ...
    <PdfOptions>
      ...
      <PreviousReportPath>\\astera.com\share\general\Sadia Sayeed\FieldVerification\MultiLineField_AutoAdjust.Txt</PreviousReportPath>
      ...
      <BaseLayout xsi:type="ReportLayout" IsHierarchicalFile="false">
        ...
        <Fields>
          <ReportLayoutField MaxFieldLengthInLayoutBuilding="6" MaxNumericValueInLayoutBuilding="0" MaxDecimalPlacesInLayoutBuilding="0" Length="20" DataType="String" IsPrimaryKey="false" Header="FIELD_1" Index="0" AllowsNull="true" IsDependent="false" IsCategorical="false" IsIncluded="true" IsFormulaField="false" IsTimeVariable="false" IsResponseVariable="false" TimeSeriesXReg="false" IsOrdinal="false" IsLagVariable="false" TimeSeriesNullTreatment="None" Name="FIELD_1">
            ...
            <UniqueId>c3c066a0-29c7-4380-b7ce-46a108057f5b</UniqueId>
        ...
        <Patterns>
          <LinePatternBase xsi:type="LinePattern">
            ...
            <PatternText>Bananas and WaterMe   </PatternText>
          </LinePatternBase>
        </Patterns>
      ...
      <BaseLayout xsi:type="ReportLayout" IsHierarchicalFile="false">
        ...
        <Fields>
          <ReportLayoutField MaxFieldLengthInLayoutBuilding="5" MaxNumericValueInLayoutBuilding="0" MaxDecimalPlacesInLayoutBuilding="0" Length="8" DataType="String" IsPrimaryKey="false" Header="FIELD_1" Index="0" AllowsNull="true" IsDependent="false" IsCategorical="false" IsIncluded="true" IsFormulaField="false" IsTimeVariable="false" IsResponseVariable="false" TimeSeriesXReg="false" IsOrdinal="false" IsLagVariable="false" TimeSeriesNullTreatment="None" Name="FIELD_1">
            ...
            <IsOutput>true</IsOutput>
            <IsVariable>false</IsVariable>
            <UniqueId>17849abf-538d-4672-9853-4e4b3498229d</UniqueId>
            <HasCollections>false</HasCollections>
            <CompositeType>None</CompositeType>
            <CompositeComponentType>None</CompositeComponentType>
        ...
        <Patterns>
          <LinePatternBase xsi:type="LinePattern">
            ...
            <IsFloatingPattern>false</IsFloatingPattern>
            <LineLength>0</LineLength>
            <PatternText>     Bananas and                   </PatternText>
          </LinePatternBase>
        </Patterns>
        <Pattern xsi:type="LinePattern">
          <IsCaseSensitiveMatch>false</IsCaseSensitiveMatch>
      ...
      <BaseLayout xsi:type="ReportLayout" IsHierarchicalFile="false">
        ...
        <Fields>
          <ReportLayoutField MaxFieldLengthInLayoutBuilding="6" MaxNumericValueInLayoutBuilding="0" MaxDecimalPlacesInLayoutBuilding="0" Length="18" DataType="String" IsPrimaryKey="false" Header="FIELD_1" Index="0" AllowsNull="true" IsDependent="false" IsCategorical="false" IsIncluded="true" IsFormulaField="false" IsTimeVariable="false" IsResponseVariable="false" TimeSeriesXReg="false" IsOrdinal="false" IsLagVariable="false" TimeSeriesNullTreatment="None" Name="FIELD_1">
            ...
            <IsOutput>true</IsOutput>
            <IsVariable>false</IsVariable>
            <UniqueId>a155ab44-b688-4b19-bbf7-7be3715973fb</UniqueId>
            <HasCollections>false</HasCollections>
            <CompositeType>None</CompositeType>
            <CompositeComponentType>None</CompositeComponentType>
            <LineCount>3</LineCount>
        ...
        <Patterns>
          <LinePatternBase xsi:type="LinePattern">
            ...
            <IsFloatingPattern>false</IsFloatingPattern>
            <LineLength>0</LineLength>
            <PatternText>            Apples                 </PatternText>
          </LinePatternBase>
        </Patterns>
        <Pattern xsi:type="LinePattern">
          <IsCaseSensitiveMatch>false</IsCaseSensitiveMatch>
      ...
      <BaseLayout xsi:type="ReportLayout" IsHierarchicalFile="false">
        ...
        <Fields>
          <ReportLayoutField MaxFieldLengthInLayoutBuilding="13" MaxNumericValueInLayoutBuilding="0" MaxDecimalPlacesInLayoutBuilding="0" Length="6" DataType="String" IsPrimaryKey="false" Header="FIELD_1" Index="0" AllowsNull="true" IsDependent="false" IsCategorical="false" IsIncluded="true" IsFormulaField="false" IsTimeVariable="false" IsResponseVariable="false" TimeSeriesXReg="false" IsOrdinal="false" IsLagVariable="false" TimeSeriesNullTreatment="None" Name="FIELD_1">
            ...
            <IsOutput>true</IsOutput>
            <IsVariable>false</IsVariable>
            <UniqueId>883eeb76-10c8-47ba-8d44-000d41fc9235</UniqueId>
            <HasCollections>false</HasCollections>
            <CompositeType>None</CompositeType>
            <CompositeComponentType>None</CompositeComponentType>
      ...
      <BaseLayout xsi:type="ReportLayout" IsHierarchicalFile="false">
        ...
        <Fields>
          <ReportLayoutField MaxFieldLengthInLayoutBuilding="13" MaxNumericValueInLayoutBuilding="0" MaxDecimalPlacesInLayoutBuilding="0" Length="6" DataType="String" IsPrimaryKey="false" Header="FIELD_1" Index="0" AllowsNull="true" IsDependent="false" IsCategorical="false" IsIncluded="true" IsFormulaField="false" IsTimeVariable="false" IsResponseVariable="false" TimeSeriesXReg="false" IsOrdinal="false" IsLagVariable="false" TimeSeriesNullTreatment="None" Name="FIELD_1">
            ...
            <IsOutput>true</IsOutput>
            <IsVariable>false</IsVariable>
            <UniqueId>0c8bcbf5-ad71-4dd9-8a15-13cacc70b16d</UniqueId>
            <HasCollections>false</HasCollections>
            <CompositeType>None</CompositeType>
            <CompositeComponentType>None</CompositeComponentType>
            <LineCount>2</LineCount>
  ...
  <MaxLineLength>35</MaxLineLength>
  <SampleFilePath>
    <Path>\\astera.com\share\general\Sadia Sayeed\FieldVerification\MultiLineField_AutoAdjust.Txt</Path>
    <UncPath>\\astera.com\share\general\Sadia Sayeed\FieldVerification\MultiLineField_AutoAdjust.Txt</UncPath>
  </SampleFilePath>
